                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Ranking</th>
                                <th>Grade</th>
                                <th><a href="module/report/spk-all.php" target="_blank"><span class="label label-success"><i class="fa fa-files-o"></i> Print Semua</span></a></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            while ($row = mysql_fetch_array($sql)) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="module/report/spk-by-alt.php?id=<?php echo $row['nik']?>" target="_blank"><span class="label label-primary"><i class="fa fa-file-pdf-o"></i> Print</span></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
